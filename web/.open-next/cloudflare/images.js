...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "http", hostname: "^(?:^(?:127\\.0\\.0\\.1)$)$", port: "8000", pathname: "^(?:\\/api\\/v1\\/public\\/media(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }, { protocol: "http", hostname: "^(?:^(?:localhost)$)$", port: "8000", pathname: "^(?:\\/api\\/v1\\/public\\/media(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }, { protocol: "https", hostname: "^(?:^(?:aitrailreporter\\.onrender\\.com)$)$", pathname: "^(?:\\/api\\/v1\\/public\\/media(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }, { protocol: "https", hostname: "^(?:^(?:picsum\\.photos)$)$", pathname: "^(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?))$" }];
